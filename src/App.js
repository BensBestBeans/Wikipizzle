    ...
    <div className="learn-container wrapper">
      ...
      <div className="learn-flexbox">
        ...
        <div className="learn-item">
          ...
          <p>
            Does the Wikipedia article contain degrading, nonsensical, very
            baised or humorous content?
          </p>
          <p>
            There might be no harm intended, but it does have the potential to
            fool viewers. Apply common sense and look at the context. Ask
            yourself if the article is informative or does it create more
            questions for you rather than answering them.
          </p>
        </div>
        <div className="learn-item"></div>
        <div className="learn-item"></div>
    ...
    <div className="tutorial-container wrapper">
      <div className="tutorial-intro intro">
        ...
        <div className="tutorial-guess">
          <div className="tutorial-guess-left">
            <p>Incorrect</p>
          </div>
          <div className="tutorial-guess-right">
            <p>Deceived! This article was generated by AI.</p>
          </div>
        </div>
        <p>
        ...
        <div className="tutorial-item-left">
          <div className="box-article box">
            ...
            <p>
              ...
              interview with the Omaha World-Herald, Petersen recalled, "I had
              long hair at the time and the bass player [at the time] was like,
              'Dude, you need a band named Joel's Hair.' I was like, 'All right,
            ...
            <p>
              ...
              critical success, receiving favorable reviews from publications
              such as Rolling Stone and Spin. The band continued to tour, and in
              1997, they released a live album, "Live at the Oasis".
            </p>
            <h2>Present Day</h2>
            <p>
              In{" "}
              ...
              . The album was in Omaha, and was again well-received by critics.
              In 2007, the band released a live DVD, "Live at the Waiting Room".
            </p>
            <p>
