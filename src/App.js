...
=======
        <h1>How did you go?</h1>
          ...
          {/* <div className="tutorial-guess">
>>>>>>> 79507ba6fb8c0fbdf9fd92397b825b6d00782795
      ...
      <div className="tutorial-main">
        <div className="tutorial-item-left">
          <div className="box-article box">
            <h2>Joel's Hair</h2>
<<<<<<< HEAD
            <p><span className="blue-box">Joel's Hair is the name of an American rock band. The band was formed in Omaha, Nebraska in 1992 by vocalist/guitarist Joel Petersen and drummer Matt Bowen. <span className="pink-box"> The band has released three albums; the latest, "The Speed of Sound", in 2007</span>. The band's name was inspired by Petersen's long hair.</span> In an interview with the Omaha World-Herald, Petersen recalled, <span className="green-box">"I had long hair at the time and the bass player [at the time] was like, 'Dude, you need a band named Joel's Hair.' I was like, 'All right, that's a good band name.'"</span></p>
=======
...
>>>>>>> 79507ba6fb8c0fbdf9fd92397b825b6d00782795
            ...
            <h2>Present Day</h2>
<<<<<<< HEAD
            <p>In <span className="pink-box">2000, the band released its third album, "The Speed of Sound"</span>. The album was in Omaha, and was again well-received by critics. In 2007, the band released a live DVD, "Live at the Waiting Room".</p>
...
<<<<<<< HEAD
            <p>Multiple successive short sentences have been used. This can be much more common in generated articles than written articles.</p>
          </div>
          ...
          <div className="green-box box">
            <p>Quotes don't sound right and don't always make sense.</p>
          </div>
=======
            <p>
      ...
      <div className="tutorial-main">
        <div className="tutorial-item-left">
          <div className="box-article box">
            <h2>Introduction</h2>
<<<<<<< HEAD
            <p>Scott Morrison (born 6 December 1967) is an Australian politician who is the 27th and current Prime Minister of Australia, <span className="blue-box">serving since 24 August 2018.</span> He is a member of the Liberal Party and <span className="blue-box">was sworn in on 24 August 2018.</span> Morrison is the first Australian Prime Minister from the Liberal Party since John Howard in 2005.</p> 
            <h2>Early Life</h2>
            <p>Morrison was born in Sydney, the son of a public servant and father of two. <span className="blue-box">He attended Waverley College and the Australian Catholic University,</span> before completing a Bachelor of Laws at the University of New South Wales. <span className="blue-box">Morrison attended Waverley College, an independent school in Sydney's Inner West, before studying law at the Australian Catholic University. </span>He then completed a Bachelor of Laws at the University of New South Wales.</p>
            <p>Morrison worked as a lawyer in private practice before being elected to the Australian House of Representatives in 2001. He was Minister for Immigration and Citizenship from <span className="pink-box">2013 to 2015,</span> and Minister for Social Services from <span className="pink-box">2007 to 2013.</span> He also served as Minister for Industry, Innovation and Science from <span className="pink-box">2013 to 2015.</span></p>
=======
            <p>
...
>>>>>>> 79507ba6fb8c0fbdf9fd92397b825b6d00782795
        ...
        <div className="tutorial-item-right">
          <div className="blue-box box">
<<<<<<< HEAD
            <p>This generated article contains recurring or redundant information.</p>
          </div>
          <div className="pink-box box">
            <p>These dates not chronological.</p>
=======
            <p>
