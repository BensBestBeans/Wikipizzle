...
const page2 = () => (
  <div className={`${style["tutorial-container"]} ${style["wrapper"]}`}>
    <div className={`${style["tutorial-intro"]} ${style["intro"]}`}>
      <h1>Tutorial 1/3 - Generated Article</h1>
      <p>
...
const page3 = () => (
  <div className={`${style["tutorial-container"]} ${style["wrapper"]}`}>
    <div className={`${style["tutorial-intro"]} ${style["intro"]}`}>
      <h1>Tutorial 2/3 - Generated Article</h1>
      <p>
...
const page4 = () => (
  <div className={`${style["tutorial-container"]} ${style["wrapper"]}`}>
    <div className={`${style["tutorial-intro"]} ${style["intro"]}`}>
      <h1>Tutorial 3/3 - Wikipedia Article</h1>
      <p>
        This is an article taken from Wikipedia. Have a read through it yourself.
      </p>
      {/* <div className={`${style["tutorial-guess"]} ${style["tut-correct"]}`}>
        <div className={`${style["tutorial-guess-left"]} ${style["correct"]}`}>
          <p>Correct!</p>
        </div>
